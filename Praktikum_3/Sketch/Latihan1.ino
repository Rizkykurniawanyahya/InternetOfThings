...
void handleRoot() {
  ...
  // Membuat tombol relay dinamis
  String relayButton;

  if (digitalRead(relayPin) == LOW) {
    relayButton = "<a href=\"/relay/on\"><button class=\"btn-on\">NYALAKAN (ON)</button></a>";
  } else {
    relayButton = "<a href=\"/relay/off\"><button class=\"btn-off\">MATIKAN (OFF)</button></a>";
  }
